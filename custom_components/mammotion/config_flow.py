...
class MammotionConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_bluetooth(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_bluetooth")
            return self.async_abort(reason="error_occurred")
    ...
    async def async_step_bluetooth_confirm(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_bluetooth_confirm")
            return self.async_abort(reason="error_occurred")
    ...
    async def async_step_user(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_user")
            return self.async_abort(reason="error_occurred")
    ...
    async def async_step_wifi(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_wifi")
            return self.async_abort(reason="error_occurred")
    ...
    async def async_step_wifi_confirm(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_wifi_confirm")
            return self.async_abort(reason="error_occurred")
    ...
    async def async_step_reconfigure(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_reconfigure")
            return self.async_abort(reason="error_occurred")
...
class MammotionConfigFlowHandler(OptionsFlowWithConfigEntry):
    ...
    async def async_step_init(
        ...
        try:
            ...
            self.error_handler.handle_error(error, "async_step_init")
            return self.async_abort(reason="error_occurred")
